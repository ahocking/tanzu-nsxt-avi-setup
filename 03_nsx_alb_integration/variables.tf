...
variable "nsx_tkg_mgmt_segment" { type = string } 
variable "nsx_tkg_ssc_segment" { type = string }
variable "nsx_tkg_alb_segment" { type = string }
variable "nsx_tkg_work_segment" { type = string }
variable "nsx_tkg_alb_cidr" { type = string }
variable "nsx_tier1" { type = string }
